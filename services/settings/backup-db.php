...
<?php
    ...
    $backup_name        = "db_aclcscheduling(".date("h:i A")."_".date('d-m-Y').").sql";
    $tables             = array("tbl_course","tbl_department","tbl_faculty","tbl_room","tbl_schedule","tbl_schoolyear","tbl_subject","tbl_user");
